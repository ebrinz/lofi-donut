...
const INITIAL_AREAS: Area[] = [
  {
    ...
    description: 'Vibrant neighborhood known for its street art and diverse culture'
  },
  {
    id: 'golden-gate-park',
    name: 'Golden Gate Park',
    description: 'Large urban park with museums, gardens, and recreational spaces'
  }
]
